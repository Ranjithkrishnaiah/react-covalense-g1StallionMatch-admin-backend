...
export class MessageTemplatesService {
  ...
  //to get all message templates list
  async findAll(
  ...
  //to create new message template
  ...
  //to get single message template details
  findOne(fields) {
  ...
  //to get single message template details by template id
  async getMessageTemplateById(messageTemplateById) {
   ...
   //to get single message template details by template uuid
